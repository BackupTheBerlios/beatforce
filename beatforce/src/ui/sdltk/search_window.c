...
static void SEARCHWINDOW_Create();
...
static void SEARCHWINDOW_Create()
{
    ...
    SEARCHWINDOW = SDL_WindowNew(0,0,1024,685);
    ...
    SDL_WidgetPropertiesOf(tablewidget,SET_FONT,SDL_FontGet("normal"));
    ...
    SDL_WidgetShow(tablewidget);

    editwidget=SDL_WidgetCreate(SDL_EDIT,312,20,400,25);
    SDL_EditSetFont(editwidget,SDL_FontGet("normal"));
    ...
    SDL_WidgetShow(editwidget);

    SEARCHWINDOW->EventHandler = SEARCHWINDOW_EventHandler;
}
